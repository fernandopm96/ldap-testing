package com.crysec.ldapprueba.security;

import com.crysec.ldapprueba.configuration.LdapConfiguration;
...
public class OpenLdapAuthenticationProvider implements AuthenticationProvider {
    ...
    private void initContext(){
        contextSource.setUrl("ldap://localhost:8389/ou=people,dc=springframework,dc=org");
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Boolean authenticate = ldapTemplate
                .authenticate(LdapUtils
                        .emptyLdapName(), filter.encode(), authentication.getCredentials().toString());
        if(authenticate){
